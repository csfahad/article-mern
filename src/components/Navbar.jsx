...
const Navbar = () => {
  ...
  const {
    userAuth,
    userAuth: { accessToken, profileImg, newNotificationAvailable },
    setUserAuth,
    ...
    <>
      <nav className="navbar z-50">
        ...
        <div className="flex items-center gap-3 md:gap-6 ml-auto">
          ...
          <Link
            to="/editor"
            className="btn-write hidden md:flex gap-2 rounded-full"
          >
          ...
          >
            <i
              ...
              } -rotate-45 text-2xl flex items-center justify-center`}
            ></i>
          </button>
